...
G.w = [nethat(-4.6), mocLenKe2(-4.6, -0.2), chain(
  // bỏ TRỌN đoạn L cuối (6 điểm) để kết thúc đúng [4.2,17.6] — slice(0,-1) chỉ bỏ 1 điểm,
  // polyline leo tới y≈14.3 rồi đoạn L kế bắt đầu lại từ 17.6 → nét demo giật lùi
  mocLenKe2(-0.2, 4.2).slice(0, -6),
  L([4.2, 17.6], [4.2, X], 3),
